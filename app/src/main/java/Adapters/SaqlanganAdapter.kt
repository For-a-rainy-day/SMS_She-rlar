...
import kotlinx.android.synthetic.main.item_shield_sevgi.view.txt_dialog_text

class SaqlanganAdapter(var context: Context, var list: ArrayList<SaqlanganModel>) :
    RecyclerView.Adapter<SaqlanganAdapter.MyViewHolder>() {
    inner class MyViewHolder(var itemview: View) : RecyclerView.ViewHolder(itemview) {
        fun onBind(model: SaqlanganModel, position: Int) {
            // itemview.tariffName.text = list[position].name
            itemview.txt_sher_saqlanganlar.text = list[position].name
            itemview.txt_sher_saqlanganlar_matn.text = list[position].code
         //   itemview.tariffCode.text = list[position].code
            ...
            itemview.setOnClickListener {
              ...
              //  dialogShow(SaqlanganModel("${itemview.tariffName.text.toString()}","${itemview.tariffCode.text.toString()}"))
                dialogShow(SaqlanganModel("${itemview.txt_sher_saqlanganlar.text.toString()}","${itemview.txt_sher_saqlanganlar_matn.text.toString()}"))
    ...
    fun dialogShow(sher: SaqlanganModel){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_saqlanganlar, parent, false)
        )
    }
