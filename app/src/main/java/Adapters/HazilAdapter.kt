...
class HazilAdapter(var context: Context, var list: ArrayList<HazilModel>) :
        RecyclerView.Adapter<HazilAdapter.MyViewHolder>() {
    inner class MyViewHolder(var itemview: View) : RecyclerView.ViewHolder(itemview) {
        fun onBind(model: HazilModel, position: Int) {
            ...
            itemview.setOnClickListener {
                ...
                dialogShow(HazilModel("${itemview.tariffName.text.toString()}","${itemview.tariffCode.text.toString()}"))
    ...
    fun dialogShow(sher: HazilModel){
