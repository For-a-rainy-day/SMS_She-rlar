...
class OtaOnaAdapter(var context: Context, var list: ArrayList<OtaOnaModels>) :
        RecyclerView.Adapter<OtaOnaAdapter.MyViewHolder>() {
    inner class MyViewHolder(var itemview: View) : RecyclerView.ViewHolder(itemview) {
        fun onBind(model: OtaOnaModels, position: Int) {
            ...
            itemview.setOnClickListener {
                ...
                dialogShow(OtaOnaModels("${itemview.tariffName.text.toString()}","${itemview.tariffCode.text.toString()}"))
...
//                }
    ...
    fun dialogShow(sher: OtaOnaModels){
